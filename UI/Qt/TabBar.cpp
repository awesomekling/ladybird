...
public:
        ...
        : QWidget(parent, Qt::ToolTip | Qt::FramelessWindowHint | Qt::NoDropShadowWindowHint)
    {
        ...
        m_thumbnail_label = new QLabel(m_card);
        m_thumbnail_label->setObjectName("LadybirdTabPreviewThumbnail");
        m_thumbnail_label->setFixedSize(TAB_PREVIEW_THUMBNAIL_WIDTH, TAB_PREVIEW_THUMBNAIL_HEIGHT);
        ...
        card_layout->addWidget(m_thumbnail_label);
    ...
    void set_preview(QPalette const& palette, QString title, QString url, QPixmap const& thumbnail)
    {
        ...
        m_thumbnail_label->setPixmap(thumbnail);
...
private:
    void update_chrome_style(QPalette const& palette)
    {
        ...
        auto thumbnail_background = ChromeStyle::style_sheet_color(ChromeStyle::chrome_surface_recessed(palette));
        auto border = ChromeStyle::style_sheet_color(ChromeStyle::chrome_control_border(palette));
...
QLabel#LadybirdTabPreviewThumbnail {{
    background: {};
    border: 1px solid {};
    border-radius: 7px;
}}
...
QLabel#LadybirdTabPreviewURL {{
    color: {};
            ...
            card_background, border, thumbnail_background, border, text, muted_text));
    }

    QFrame* m_card { nullptr };
    QLabel* m_thumbnail_label { nullptr };
