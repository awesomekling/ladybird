...
public:
    ...
    void start_revalidation_request(Badge<Request>, ByteString method, URL::URL, NonnullRefPtr<HTTP::HeaderList> request_headers, ByteBuffer request_body, Optional<Core::AnonymousBuffer> request_body_buffer, HTTP::Cookie::IncludeCredentials, Core::ProxyData proxy_data);
...
private:
    ...
    virtual void start_request(u64 request_id, ByteString, URL::URL, Vector<HTTP::Header>, ByteBuffer, Optional<Core::AnonymousBuffer>, HTTP::CacheMode, HTTP::Cookie::IncludeCredentials, Core::ProxyData) override;
