...
def generate_header_file(out: TextIO, value_type_data: dict[str, Any]) -> None:
    out.write("""// This file is generated by generate_libweb_css_value_types.py
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate CSS value types", add_help=False)
    parser.add_argument("--help", action="help", help="Show this help message and exit")
    parser.add_argument(
        "-h",
        "--header",
        required=True,
        help="Path to the GeneratedValueTypes header file to generate",
    )
