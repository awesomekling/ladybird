...
public:
    ...
    [[nodiscard]] i32 iterator_result_object_value_offset() { return m_iterator_result_object_value_offset; }
    [[nodiscard]] i32 iterator_result_object_done_offset() { return m_iterator_result_object_done_offset; }

    [[nodiscard]] GC::Ref<Shape> normal_function_prototype_shape() { return *m_normal_function_prototype_shape; }
    [[nodiscard]] i32 normal_function_prototype_constructor_offset() const { return m_normal_function_prototype_constructor_offset; }

    [[nodiscard]] GC::Ref<Shape> normal_function_shape() { return *m_normal_function_shape; }
    [[nodiscard]] i32 normal_function_length_offset() const { return m_normal_function_length_offset; }
    [[nodiscard]] i32 normal_function_name_offset() const { return m_normal_function_name_offset; }

    [[nodiscard]] GC::Ref<Shape> native_function_shape() { return *m_native_function_shape; }
    [[nodiscard]] i32 native_function_length_offset() const { return m_native_function_length_offset; }
    [[nodiscard]] i32 native_function_name_offset() const { return m_native_function_name_offset; }

    [[nodiscard]] GC::Ref<Shape> unmapped_arguments_object_shape() { return *m_unmapped_arguments_object_shape; }
    [[nodiscard]] i32 unmapped_arguments_object_length_offset() const { return m_unmapped_arguments_object_length_offset; }
    [[nodiscard]] i32 unmapped_arguments_object_well_known_symbol_iterator_offset() const { return m_unmapped_arguments_object_well_known_symbol_iterator_offset; }
    [[nodiscard]] i32 unmapped_arguments_object_callee_offset() const { return m_unmapped_arguments_object_callee_offset; }

    [[nodiscard]] GC::Ref<Shape> mapped_arguments_object_shape() { return *m_mapped_arguments_object_shape; }
    [[nodiscard]] i32 mapped_arguments_object_length_offset() const { return m_mapped_arguments_object_length_offset; }
    [[nodiscard]] i32 mapped_arguments_object_well_known_symbol_iterator_offset() const { return m_mapped_arguments_object_well_known_symbol_iterator_offset; }
    [[nodiscard]] i32 mapped_arguments_object_callee_offset() const { return m_mapped_arguments_object_callee_offset; }

    [[nodiscard]] GC::Ref<Shape> regexp_builtin_exec_array_shape() { return *m_regexp_builtin_exec_array_shape; }
    [[nodiscard]] i32 regexp_builtin_exec_array_index_offset() const { return m_regexp_builtin_exec_array_index_offset; }
    [[nodiscard]] i32 regexp_builtin_exec_array_input_offset() const { return m_regexp_builtin_exec_array_input_offset; }
    [[nodiscard]] i32 regexp_builtin_exec_array_groups_offset() const { return m_regexp_builtin_exec_array_groups_offset; }
...
#undef __JS_ENUMERATE
    ...
    i32 m_iterator_result_object_value_offset { 0 };
    i32 m_iterator_result_object_done_offset { 0 };

    GC::Ptr<Shape> m_normal_function_prototype_shape;
    i32 m_normal_function_prototype_constructor_offset { 0 };

    GC::Ptr<Shape> m_normal_function_shape;
    i32 m_normal_function_length_offset { 0 };
    i32 m_normal_function_name_offset { 0 };

    GC::Ptr<Shape> m_native_function_shape;
    i32 m_native_function_length_offset { 0 };
    i32 m_native_function_name_offset { 0 };

    GC::Ptr<Shape> m_unmapped_arguments_object_shape;
    i32 m_unmapped_arguments_object_length_offset { 0 };
    i32 m_unmapped_arguments_object_well_known_symbol_iterator_offset { 0 };
    i32 m_unmapped_arguments_object_callee_offset { 0 };

    GC::Ptr<Shape> m_mapped_arguments_object_shape;
    i32 m_mapped_arguments_object_length_offset { 0 };
    i32 m_mapped_arguments_object_well_known_symbol_iterator_offset { 0 };
    i32 m_mapped_arguments_object_callee_offset { 0 };
    ...
    i32 m_regexp_builtin_exec_array_index_offset { 0 };
    i32 m_regexp_builtin_exec_array_input_offset { 0 };
    i32 m_regexp_builtin_exec_array_groups_offset { 0 };
