...
NEVER_INLINE Completion throw_null_or_undefined_property_get(VM& vm, Value base_value, GetBaseIdentifier get_base_identifier, GetPropertyName get_property_name)
{
...
NEVER_INLINE ThrowCompletionOr<Value> get_by_id_slow_path(
