...
public:
    ...
    // the phi instruction that needs a value. The mapper should return the
    // value to use for this phi's new predecessor operand.
    ...
    static void redirect_edge(
        ...
        AK::Function<Value*(Instruction& phi)> value_mapper = nullptr);
