...
#undef LOWER_PUT_ACCESSOR_BY_VALUE_WITH_THIS
    ...
    case Opcode::Call: {
        ...
        emit_with_extra_operand_slots<Bytecode::Op::Call>(args.size(), dst(), operand(0), operand(1), instruction.expression_string(), instruction.cache_index().value(), ReadonlySpan<Bytecode::Operand> { args });
        break;
    }
