...
GC::Ref<JS::Object> Internals::style_invalidation_counters_object() const
{
    ...
    object->define_direct_property("elementStyleInputsFromAnimationBaseStyle"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_animation_base_style), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromAnimationInheritedDescendants"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_animation_inherited_descendants), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromViewportDependentNodes"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_viewport_dependent_nodes), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromViewportDependentElements"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_viewport_dependent_elements), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromStyleContainerQueries"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_style_container_queries), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromTreeCountingFunctions"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_tree_counting_functions), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromElementStyleEnvironment"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_element_style_environment), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromDescendantStyleEnvironment"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_descendant_style_environment), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromSlotAssignment"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_slot_assignment), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromSizeContainerQueries"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_size_container_queries), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromLinkState"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_link_state), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromTreeMoves"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_tree_moves), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromSVGFilterImageResources"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_svg_filter_image_resources), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromSVGImageResources"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_svg_image_resources), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromDirectChildReactions"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_direct_child_reactions), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromUnabsorbedReactions"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_unabsorbed_reactions), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromRepeatedReactions"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_repeated_reactions), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromInheritedReactions"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_inherited_reactions), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromTableCellPadding"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_table_cell_padding), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromImageDimensionSources"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_image_dimension_sources), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromImageDataCacheHits"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_image_data_cache_hits), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromResponsiveImageDataCacheHits"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_responsive_image_data_cache_hits), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromImageDataLoads"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_image_data_loads), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromImageEnvironmentChanges"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_image_environment_changes), JS::default_attributes);
    object->define_direct_property("elementStyleInputsFromIFrameMargins"_utf16_fly_string, JS::Value(counters.element_style_inputs_from_iframe_margins), JS::default_attributes);
