...
JS::Object* Internals::get_style_invalidation_counters()
{
    ...
    object->define_direct_property("hasSiblingAnchorInvalidationChecks"_utf16_fly_string, JS::Value(counters.has_sibling_anchor_invalidation_checks), JS::default_attributes);
