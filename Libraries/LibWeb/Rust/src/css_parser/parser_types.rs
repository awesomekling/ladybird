...
pub enum CssRuleEventKind {
    ...
    FunctionParameterTypeUniversal,
    FunctionParameterTypeIdent,
    FunctionParameterTypeType,
    FunctionParameterTypeMultiplierStart,
    FunctionParameterTypeMultiplierEnd,
    FunctionParameterTypeCommaSeparatedMultiplierStart,
    FunctionParameterTypeCommaSeparatedMultiplierEnd,
    FunctionParameterTypeAlternativesStart,
    FunctionParameterTypeAlternativesEnd,
    FunctionParameterDefaultValueStart,
    FunctionParameterDefaultValueEnd,
    FunctionParameterEnd,
    FunctionReturnTypeStart,
    FunctionReturnTypeEnd,
    ImportUrl,
    ImportUrlModifier,
    ImportLayer,
    ImportSupportsDeclarationStart,
    ImportSupportsDeclarationEnd,
