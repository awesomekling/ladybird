...
define_ffi_ops! {
    ...
    TransformGroupPayloadAssemblerCallback => "transformGroupPayloadAssemblerCallbacks",
    EffectsGroupPayloadAssemblerCallback => "effectsGroupPayloadAssemblerCallbacks",
    AnchorGroupPayloadAssemblerCallback => "anchorGroupPayloadAssemblerCallbacks",
    InheritedUIGroupPayloadAssemblerCallback => "inheritedUIGroupPayloadAssemblerCallbacks",
    InheritedSVGGroupPayloadAssemblerCallback => "inheritedSVGGroupPayloadAssemblerCallbacks",
    InheritedTextGroupPayloadAssemblerCallback => "inheritedTextGroupPayloadAssemblerCallbacks",
    AnimationGroupPayloadAssemblerCallback => "animationGroupPayloadAssemblerCallbacks",
