...
pub use css_parser::{
    ...
    CssPageSelector, CssPaintOrderKeyword, CssPaintOrderValue, CssPaintOrderValueKind, CssParsedColorKind,
...
/// - Parameters provided to `callback` must be valid pointers
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rust_css_parse_layer_shorthand(
    property_id: u16,
    input: *const u8,
    input_len: usize,
    ctx: *mut c_void,
    ...
    unsafe {
        abort_on_panic(|| {
            ...
            css_parser::parse_layer_shorthand(property_id, input, |layer_index, property_id, value| {
                callback(ctx, layer_index, property_id, value.as_ptr(), value.len());
            })
        })
    }
...
/// - Parameters provided to `callback` must be valid pointers
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rust_css_parse_font_shorthand(
    input: *const u8,
    input_len: usize,
    ctx: *mut c_void,
    ...
    unsafe {
        abort_on_panic(|| {
            ...
            css_parser::parse_font_shorthand(input, |property_id, value| {
...
/// - Parameters provided to `callback` must be valid pointers
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rust_css_parse_grid_placement_shorthand(
    property_id: u16,
    input: *const u8,
    input_len: usize,
    ctx: *mut c_void,
    ...
    unsafe {
        abort_on_panic(|| {
            ...
            css_parser::parse_grid_placement_shorthand(property_id, input, |property_id, value| {
                callback(ctx, property_id, value.as_ptr(), value.len());
            })
        })
    }
...
/// - Parameters provided to `callback` must be valid pointers
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rust_css_parse_syntax_component_prefix(
    input: *const u8,
    input_len: usize,
    limit_single_component_ident_to_custom_ident: bool,
    ctx: *mut c_void,
    ...
    unsafe {
        abort_on_panic(|| {
            ...
            css_parser::parse_syntax_component_prefix(
                input,
...
/// - `input` and `input_len` must point to a valid string
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rust_css_parse_text_wrap_mode(input: *const u8, input_len: usize) -> CssTextWrapModeValue {
    unsafe {
        abort_on_panic(|| {
            let Some(input) = bytes_from_raw(input, input_len) else {
            ...
            css_parser::parse_text_wrap_mode_value(input)
        })
    }
}
...
/// - `input` and `input_len` must point to a valid string
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rust_css_parse_text_wrap_style(input: *const u8, input_len: usize) -> CssTextWrapStyleValue {
    unsafe {
        abort_on_panic(|| {
            let Some(input) = bytes_from_raw(input, input_len) else {
...
/// - `input` and `input_len` must point to a valid string
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rust_css_parse_scrollbar_gutter(
    input: *const u8,
    input_len: usize,
) -> CssScrollbarGutterValueKind {
    unsafe {
        abort_on_panic(|| {
            let Some(input) = bytes_from_raw(input, input_len) else {
...
/// - Parameters provided to `name_callback` must be valid pointers
#[unsafe(no_mangle)]
pub unsafe extern "C" fn rust_css_parse_view_transition_name(
    input: *const u8,
    input_len: usize,
    ctx: *mut c_void,
    name_callback: unsafe extern "C" fn(ctx: *mut c_void, value_ptr: *const u8, value_len: usize),
    ...
    unsafe {
        abort_on_panic(|| {
            ...
            css_parser::parse_view_transition_name_value(input, |name| {
                name_callback(ctx, name.as_ptr(), name.len());
            })
        })
    }
