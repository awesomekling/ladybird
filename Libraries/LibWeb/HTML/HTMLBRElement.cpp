...
GC::Ptr<Layout::Node> HTMLBRElement::create_layout_node(NonnullRefPtr<CSS::ComputedProperties> style)
{
...
void HTMLBRElement::apply_presentational_hints(CSS::CascadedProperties& cascaded_properties) const
{
