...
void HTMLObjectElement::apply_presentational_hints(CSS::CascadedProperties& cascaded_properties) const
{
...
GC::Ptr<Layout::Node> HTMLObjectElement::create_layout_node()
{
