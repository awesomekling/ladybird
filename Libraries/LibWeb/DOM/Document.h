...
public:
    ...
    struct StyleInvalidationCounters {
        ...
        u64 element_style_inputs_from_animation_base_style { 0 };
        u64 element_style_inputs_from_animation_inherited_descendants { 0 };
        u64 element_style_inputs_from_viewport_dependent_nodes { 0 };
        u64 element_style_inputs_from_viewport_dependent_elements { 0 };
        u64 element_style_inputs_from_style_container_queries { 0 };
        u64 element_style_inputs_from_tree_counting_functions { 0 };
        u64 element_style_inputs_from_element_style_environment { 0 };
        u64 element_style_inputs_from_descendant_style_environment { 0 };
        u64 element_style_inputs_from_slot_assignment { 0 };
        u64 element_style_inputs_from_size_container_queries { 0 };
        u64 element_style_inputs_from_link_state { 0 };
        u64 element_style_inputs_from_tree_moves { 0 };
        u64 element_style_inputs_from_svg_filter_image_resources { 0 };
        u64 element_style_inputs_from_svg_image_resources { 0 };
        u64 element_style_inputs_from_direct_child_reactions { 0 };
        u64 element_style_inputs_from_unabsorbed_reactions { 0 };
        u64 element_style_inputs_from_repeated_reactions { 0 };
        u64 element_style_inputs_from_inherited_reactions { 0 };
        u64 element_style_inputs_from_table_cell_padding { 0 };
        u64 element_style_inputs_from_image_dimension_sources { 0 };
        u64 element_style_inputs_from_image_data_cache_hits { 0 };
        u64 element_style_inputs_from_responsive_image_data_cache_hits { 0 };
        u64 element_style_inputs_from_image_data_loads { 0 };
        u64 element_style_inputs_from_image_environment_changes { 0 };
        u64 element_style_inputs_from_iframe_margins { 0 };
