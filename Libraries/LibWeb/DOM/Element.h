...
#undef __ENUMERATE_ARIA_ATTRIBUTE
    ...
    bool affected_by_has_pseudo_class_with_relative_selector_that_has_next_sibling_combinator() const { return m_affected_by_has_pseudo_class_with_relative_selector_that_has_next_sibling_combinator; }
    void set_affected_by_has_pseudo_class_with_relative_selector_that_has_next_sibling_combinator(bool value) { m_affected_by_has_pseudo_class_with_relative_selector_that_has_next_sibling_combinator = value; }
    bool affected_by_has_pseudo_class_with_relative_selector_that_has_subsequent_sibling_combinator() const { return m_affected_by_has_pseudo_class_with_relative_selector_that_has_subsequent_sibling_combinator; }
    void set_affected_by_has_pseudo_class_with_relative_selector_that_has_subsequent_sibling_combinator(bool value) { m_affected_by_has_pseudo_class_with_relative_selector_that_has_subsequent_sibling_combinator = value; }
    ...
    bool in_subtree_of_has_pseudo_class_relative_selector_with_nested_sibling_combinator() const { return m_in_subtree_of_has_pseudo_class_relative_selector_with_nested_sibling_combinator; }
    void set_in_subtree_of_has_pseudo_class_relative_selector_with_nested_sibling_combinator(bool value) { m_in_subtree_of_has_pseudo_class_relative_selector_with_nested_sibling_combinator = value; }
    bool in_subtree_of_has_pseudo_class_relative_selector_with_next_sibling_combinator() const { return m_in_subtree_of_has_pseudo_class_relative_selector_with_next_sibling_combinator; }
    void set_in_subtree_of_has_pseudo_class_relative_selector_with_next_sibling_combinator(bool value) { m_in_subtree_of_has_pseudo_class_relative_selector_with_next_sibling_combinator = value; }
    bool in_subtree_of_has_pseudo_class_relative_selector_with_subsequent_sibling_combinator() const { return m_in_subtree_of_has_pseudo_class_relative_selector_with_subsequent_sibling_combinator; }
    void set_in_subtree_of_has_pseudo_class_relative_selector_with_subsequent_sibling_combinator(bool value) { m_in_subtree_of_has_pseudo_class_relative_selector_with_subsequent_sibling_combinator = value; }
...
private:
    ...
    bool m_affected_by_has_pseudo_class_with_relative_selector_that_has_next_sibling_combinator : 1 { false };
    bool m_affected_by_has_pseudo_class_with_relative_selector_that_has_subsequent_sibling_combinator : 1 { false };
    bool m_in_subtree_of_has_pseudo_class_relative_selector_with_sibling_combinator : 1 { false };
    bool m_in_subtree_of_has_pseudo_class_relative_selector_with_nested_sibling_combinator : 1 { false };
    bool m_in_subtree_of_has_pseudo_class_relative_selector_with_next_sibling_combinator : 1 { false };
    bool m_in_subtree_of_has_pseudo_class_relative_selector_with_subsequent_sibling_combinator : 1 { false };
