...
Optional<RustComponentValueParser::RustStyleValue> RustComponentValueParser::parse_style_value(ReadonlySpan<PropertyID> property_ids, Optional<ValueType> value_type, StringView input,
    bool allow_quirky_length, bool allow_quirky_color, bool allow_svg_unitless_length, bool allow_svg_unitless_angle)
{
    ...
    auto calculation_callback = [](void* raw_style_value, FFI::CssCalculationNodeKind kind, FFI::CssPrimitiveValueKind primitive_kind, bool has_numeric_value, double numeric_value, u32 child_count, u8 const* metadata_ptr, size_t metadata_len) {
        auto& context = *static_cast<StyleValueParseContext*>(raw_style_value);
        context.flush_source_component_values();
        auto& style_value = context.style_value;
        VERIFY(style_value.has_value());
    ...
    auto url_modifier_callback = [](void* raw_style_value, FFI::CssUrlModifier const* rust_modifier) {
        auto& context = *static_cast<StyleValueParseContext*>(raw_style_value);
        context.flush_source_component_values();
        auto& style_value = context.style_value;
        VERIFY(style_value.has_value());
    ...
    auto source_component_value_list_callback = [](void* raw_style_value, u8 kind) {
        auto& context = *static_cast<StyleValueParseContext*>(raw_style_value);
        context.start_source_component_values(kind);
    };
    auto source_component_value_callback = [](void* raw_style_value, FFI::CssComponentValue const* component_value) {
        auto& context = *static_cast<StyleValueParseContext*>(raw_style_value);
    ...
    if (value_type.has_value()) {
        ...
        FFI::rust_css_parse_style_value_for_value_type(
            ffi_property_ids.first(),
...
Optional<RustComponentValueParser::RustStyleValue> RustComponentValueParser::parse_style_value_for_property(ReadonlySpan<PropertyID> property_ids, StringView input,
    bool allow_quirky_length, bool allow_quirky_color, bool allow_svg_unitless_length, bool allow_svg_unitless_angle)
{
    return RustComponentValueParser::parse_style_value(property_ids, {}, input, allow_quirky_length, allow_quirky_color, allow_svg_unitless_length, allow_svg_unitless_angle);
}

Optional<RustComponentValueParser::RustStyleValue> RustComponentValueParser::parse_style_value_for_value_type(PropertyID property_id, ValueType value_type, StringView input,
    bool allow_quirky_length, bool allow_quirky_color, bool allow_svg_unitless_length, bool allow_svg_unitless_angle)
{
    return RustComponentValueParser::parse_style_value({ &property_id, 1 }, value_type, input, allow_quirky_length, allow_quirky_color, allow_svg_unitless_length, allow_svg_unitless_angle);
}
